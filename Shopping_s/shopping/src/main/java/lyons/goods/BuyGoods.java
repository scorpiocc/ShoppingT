...
*/                           System.out.println("莫名异常："+e);
                            ...
                            out.print(e+"<br>");
                            out.print("返回"+"");
                            out.print("<a href=/Adapter/jsp/shoppingCar/lookShoppingCar.jsp>购物车</a>");
                            return;
                        }finally
                        {
...
//      ArrayList<Goods> goodsList = new ArrayList<Goods>();
    ...
    public void messShopping(HttpServletRequest request, HttpServletResponse response, String mess)
    {
        try
        {
            ...
            out.print("<br><br><br>");
            out.print("<a href=/Adapter/jsp/browse/showGoods.jsp>返回继续购物</a>");
            out.print("&nbsp;or&nbsp;");
            out.print("<a href=/Adapter/lyons.dao/GoodsDao?key=3>查看订单</a></center>");
        } catch (IOException e)
        {
            e.printStackTrace();
        }
