...
public class GoodsDao extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		if (username==null)
		{
          ...
          {
        	  out.print("<head><title>请登陆</title></head>");
              out.print("<br>");
              out.print("<center><font color=#008B8B> 登陆之后才能查看哦  </font>");
              out.print("<a href=/Adapter/jsp/join/login.jsp><font color=red size=6>登陆</font></a></center>");
                    ...
                    try
                    {
                        ...
                        if(rs.next())
                        {
                        ...
                        }else
                            {
                                ...
                                out.print("<a href=/Adapter/lyons.dao/GoodsDao?key=4><font color=red size=6>Go Shopping</font></a>");
                                out.print("</center>");
                            }
                    } catch (SQLException e)
                    {
			...
			case 4:
					...
					try
					{
						...
						}else
                        {
                                ...
                                out.print("<a href=/Adapter/lyons.dao/GoodsDao?key=4><font color=red size=6>进入首页</font></a>");
                                out.print("</center>");
                            }
					} catch (SQLException e)
					{
						e.printStackTrace();
						response.sendRedirect("/Adapter/jsp/browse/showGoods.jsp");
					}finally
							{
								DbClose.allClose(pstmt, rs, conn);
							}
